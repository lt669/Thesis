...
\section{Introduction}
	...
	% The project described in this document aims to extend the functionality of a currently implemented system called the \ac{VSS} situated in the listening space of the Audio Lab at the University of York. The system allows a user to hear themselves as though they are present in another acoustic environment. This project looks into extending this functionality to allow the user to move themselves around a digitally modelled version of Hendrix Hall, one of the lecture halls on the Universities campus by generation a large grid of synthetic room impulse responses using the room acoustic simulation software Odeon.

	%The project described in this document aims to build upon an existing system called the \ac{VSS}, a system that allows a user to hear themselves as though they are present in another acoustic environment, situated in the listening space of the Audio Lab at the University of York. This project looks into extending this functionality to allow the user to move themselves around a digitally modelled version of Hendrix Hall, one of the lecture halls on the Universities campus by generation a large grid of synthetic room impulse responses using the room acoustic simulation software Odeon.

	%The way in which sound propagates around a room has been of great interest to audiophiles and scientists alike for some time and vast amounts of literature on the subject now exists. This research in conjunction with room modelling software has led to the ability to simulate how sound would propagate around a room, something that has multiple benefits, from allowing architects to hear how a room would sound before it is built, recreating lost buildings to hear what they might have sounded like or allowing someone to feel as though they are present in a room one second and present in another room the next. It is upon these techniques that the project described in the document is based.

	%The ability to recreate the acoustics of a room has been well established tool for many years and has provided ample opportunity for research in areas such as acoustic and performance analysis by allowing the acoustics of multiple rooms quickly and easily without having to revisit said rooms. Furthermore, the ability to simulate the acoustics of a room through the use of room modelling software and sound propagation simulations has further enhanced the world of research by enabling us to hear what a room might sound like that we can not get to, or even allow us to hear what a room that no longer exists, or maybe never existed might sound like.
