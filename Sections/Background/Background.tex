...
%The the original \ac{VSS} used an Oculus Rift, using 3D images was possible. However, this was more simple as the user place within the \ac{VAE} was static, therefore the movement was not an issue. it was decided that this functionality was not going to be implemented as interpolation between images is not convincing compared to interpolation between \ac{RIR}'s.
