...
\subsection{ODEON}
	...
	\label{odeon:materials}
		...
		\subsubsection{Odeon Output Settings}
			...
			\begin{figure}[h]
				\centerline{\includegraphics[scale = 0.35]{Sections/Implementation/Odeon/images/OdeonSettings/settingsFigure_edit.png}}
				\caption{\ac{RIR}'s rendered using different \ac{TO} and late ray values}
				\label{odeonSettingsRIR}
			\end{figure}
				%-------------TO and LR value Zoomed image-------------%
			\begin{figure}[h]
				\centerline{\includegraphics[scale = 0.33]{Sections/Implementation/Odeon/images/OdeonSettings/settingsFigureZoomed.png}}
